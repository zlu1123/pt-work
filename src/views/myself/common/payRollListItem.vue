<template>
  <div>
    ...
    <div class="pay-roll-claimed">
      <div class="title">
        <div>职位：顺丰快递分派员（顺丰）</div>
        <div>12元/小时</div>
      </div>
      <div v-if="!listItem.claimed" class="receive-time">领取时间：2019-11-08 20:00:05</div>
      <div class="work-time">工作日期：2019-11-08 至 2019-11-08</div>
