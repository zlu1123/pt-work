      ...
      <div class="uni-calendar__box">
        ...
        <div class="uni-calendar__weeks">
          <div class="uni-calendar__weeks-day">
            <span class="uni-calendar__weeks-day-span">日</span>
          </div>
          <div class="uni-calendar__weeks-day">
            <span class="uni-calendar__weeks-day-span">一</span>
          </div>
          <div class="uni-calendar__weeks-day">
            <span class="uni-calendar__weeks-day-span">二</span>
          </div>
          <div class="uni-calendar__weeks-day">
            <span class="uni-calendar__weeks-day-span">三</span>
          </div>
          <div class="uni-calendar__weeks-day">
            <span class="uni-calendar__weeks-day-span">四</span>
          </div>
          <div class="uni-calendar__weeks-day">
            <span class="uni-calendar__weeks-day-span">五</span>
          </div>
          <div class="uni-calendar__weeks-day">
...
.uni-calendar__mask {
  ...
  left: 0;
  right: 0;
  background-color: @uni-font-size-base;
